...
android {
    namespace = "com.mayank.ivrrecordapp"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.mayank.ivrrecordapp"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation ("androidx.compose.material3:material3:1.2.0" )// Use the latest stable version
